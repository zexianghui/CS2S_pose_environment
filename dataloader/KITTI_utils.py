...
SatMap_original_sidelength = 1280 # 0.2 m per pixel
SatMap_process_sidelength = 512 # 0.2 m per pixel
SatMap_end_sidelength = 256 # 0.2 m per pixel
Default_lat = 49.015

CameraGPS_shift_left = [1.08, 0.26]
CameraGPS_shift_right = [1.08, 0.8]  # 0.26 + 0.54

min_utm_x = 608364.0249777737
max_utm_x = 621051.813481476
min_utm_y = 4114900.81692448
max_utm_y = 4118728.8404802806
...
# meter_per_pixel *= SatMap_end_sidelength / 256
# print(1)