...
from models.swin_transformer_v2.model_parts import PatchEmbedding, SwinTransformerStage
...
class SwinTransformerV2(nn.Module):
    ...
    def forward(self, input: torch.Tensor) -> List[torch.Tensor]:
        ...
        return features  # [1, 96, 128, 128] [1, 192, 64, 64] [1, 384, 32, 32] [1, 768, 16, 16]
